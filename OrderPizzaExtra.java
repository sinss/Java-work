...
public class OrderPizzaExtra
{
    ...
    public static void main(String[] args)
    {
        ...
        try
        {
            ...
            //each pizza has to ask once
            for (int i = 1 ; i <= pizza ; i ++)
            {
            	int toppings = readValue("How many toppings on each pizza? would you like on pizza # " + i);
            	subtotal = subtotal + calculateSubtotalWithoutWings(1, toppings);
            }
            
            int wings = readValue("How many orders of wings would you like?");
            
            subtotal = subtotal + calculateWings(wings);
